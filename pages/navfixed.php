		...
		<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse">
				<ul class="nav" id="side-menu">
					...
					<li>
						<a href="products.php"><i class="fa fa-table fa-fw"></i> Danh sách món ăn</a>
					</li>
					<li>
						<a href="customer.php"><i class="fa fa-user fa-fw"></i> Danh sách nhân viên</a>
					</li>
					<li>
					...
					<li>
						<a href="supplier.php"><i class="fa fa-truck fa-fw"></i> Giao hàng</a>
					</li>

					<li>
						<a rel="facebox" href="select_customer.php"><i class="fa fa-book fa-fw"></i> Thống kê</a>
					</li>
					<li>
						<a href="#"><i class="fa fa-files-o fa-fw"></i> Báo cáo<span class="fa arrow"></span></a>
